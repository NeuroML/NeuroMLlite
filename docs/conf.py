...
latex_documents = [
    (
        "index",
        "NeuroMLlite.tex",
        "NeuroMLlite Documentation",
        "NeuroMLlite authors and contributors",
        "manual",
    ),
]
...
texinfo_documents = [
    (
        ...
        "NeuroMLlite authors and contributors",
        "NeuroMLlite",
        "This package provides NeuroMLlite for working with neuronal models specified in NeuroML 2.",
        "Miscellaneous",
    ),
]
