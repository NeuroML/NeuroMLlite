...
from neuromllite import RelativeLayout, Cell, Synapse, InputSource, Input, RectangularRegion
...
r2 = RectangularRegion(id='region2', x=1000,y=1000,z=1000,width=1000,height=100,depth=1000)
...
net.cells.append(Cell(id='hhcell', neuroml2_source_file='../../../examples/test_files/hhcell.cell.nml'))
net.synapses.append(Synapse(id='ampa', neuroml2_source_file='../../../examples/test_files/ampa.synapse.nml'))
