...
def generate_neuroml2_from_network(nl_model, 
    ...
    if simulation is not None:
        if simulation.dt is not None:
            print_v(nml_doc.networks[0].properties.append(neuroml.Property('recommended_dt_ms',simulation.dt)))
        if simulation.duration is not None:
            print_v(nml_doc.networks[0].properties.append(neuroml.Property('recommended_duration_ms',simulation.duration)))
