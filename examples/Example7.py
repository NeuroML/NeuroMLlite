...
if __name__ == "__main__":
    ...
    if "-sweep" in sys.argv:
        ...
        nmllr = NeuroMLliteRunner("SimExample7.json", simulator=simulator)
        ...
        ps.plotLines(
            "eta",
            "expoisson/0/poisson_input/spike:mean_spike_frequency",
            second_param="seed",
            save_figure_to="mean_spike_frequency_ein.png",
        )
        ps.plotLines(
            "eta",
            "inpoisson/0/poisson_input/spike:mean_spike_frequency",
            second_param="seed",
            save_figure_to="mean_spike_frequency_iin.png",
        )
        ps.plotLines(
            "eta",
            "Epop/0/ifcell/spike:mean_spike_frequency",
            second_param="seed",
            save_figure_to="mean_spike_frequency_e.png",
        )
        ps.plotLines(
            "eta",
            "Ipop/0/ifcell/spike:mean_spike_frequency",
            second_param="seed",
            save_figure_to="mean_spike_frequency_i.png",
        )
