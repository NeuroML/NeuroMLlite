from neuromllite import Network, Cell, InputSource, Population
...
input_cell.parameters = {"start": 0, "duration": 10000000000, "rate": "input_rate"}
...
input_source1 = InputSource(
    id="iclamp1",
    pynn_input="DCSource",
    parameters={"amplitude": 0.8, "start": 100.0, "stop": 900.0},
)
...
pop0 = Population(
    id="pop0", size="N", component=cell.id, properties={"color": ".7 0 0"}
)
net.populations.append(pop0)
pop1 = Population(
    id="pop1", size="N", component=cell.id, properties={"color": "0 .7 0"}
)
net.populations.append(pop1)
pop2 = Population(
    id="pop2", size="N", component=cell.id, properties={"color": "0 .7 0.7"}
)
net.populations.append(pop2)
#

ipop0 = Population(
    id="input_pop0", size="N", component=input_cell.id, properties={"color": ".7 .7 .7"}
)
net.populations.append(ipop0)
ipop1 = Population(
    id="input_pop1",
    size="N",
    component=input_cell_100.id,
    properties={"color": ".7 .1 .7"},
)
...
net.inputs.append(
    Input(id="stim1", input_source=input_source1.id, population=pop1.id, percentage=100)
)

net.inputs.append(
    Input(id="stim2", input_source=input_source1.id, population=pop2.id, percentage=50)
)
