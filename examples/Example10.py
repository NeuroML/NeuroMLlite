from neuromllite import Network, Cell, Population
...
cell = Cell(
    id="lorenzCell", lems_source_file="test_files/Lorenz1963.xml", parameters={}
)
...
pop = Population(
    id="lorenzPop", size="1", component=cell.id, properties={"color": ".7 0 0"}
)
...
sim = Simulation(
    ...
    plots2D={
        ...
        "X-Z": {"x_axis": "lorenzPop[0]/x", "y_axis": "lorenzPop[0]/z"},
    },
    plots3D={
        "X-Y-Z": {
            "x_axis": "lorenzPop[0]/x",
