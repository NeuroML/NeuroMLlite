...
r1 = RectangularRegion(
    id="region1", x=0, y=200, z=0, width=1000, height=100, depth=1000
)
...
p0 = Population(
    ...
    random_layout=RandomLayout(region=r0.id),
)
...
net.inputs.append(
    Input(id="stim", input_source=input_source.id, population=p0.id, percentage=100)
)
